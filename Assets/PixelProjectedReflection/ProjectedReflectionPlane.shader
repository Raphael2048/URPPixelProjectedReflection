...
Shader "ProjectedReflectionPlane"
{
	Properties
	{
		...
		SubShader
		{
			...
			half3 ReflectionGI(BRDFData brdfData, half3 bakedGI, half occlusion, half3 normalWS, half3 viewDirectionWS, half2 uv)
			{
			...
			half4 LitPassFragment(Varyings input) : SV_Target
			{
				...
				half2 uv = input.positionCS.xy * (_ScreenParams.zw - 1);
				half3 color = ReflectionGI(brdfData, bakedGI, surfaceData.occlusion, normalWS, viewDirectionWS, uv);
